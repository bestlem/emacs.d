...
#+end_src
***** Centaur pretty-hydra-title
:PROPERTIES:
:ID:       org_mark_mini20.local:20210602T225047.764883
:END:
Used as a function to give an iconized title
#+NAME: org_mark_mini20.local_20210602T225047.737701
#+begin_src emacs-lisp
...
(use-package treemacs-projectile
  :mwb-load-path "fork/treemacs/src/extra"
