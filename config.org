...
*** Directories
:PROPERTIES:
:ID:       org_mark_mini20.local:20220614T210326.131237
:END:
#+NAME: org_mark_mini20.local_20220614T210326.105802
#+begin_src emacs-lisp
(defvar mwb-emacs-work-dir (expand-file-name "~/.local/emacs" )
  "Directory on local machine wwhere emacs outside start directory.")

(defvar mwb-emacs-eln-cache-dir (expand-file-name "eln-cache" mwb-emacs-work-dir))
...
(setq native-comp-eln-load-path (cons mwb-emacs-eln-cache-dir (cdr native-comp-eln-load-path)))
#+end_src
*** Setup
:PROPERTIES:
