...
#+NAME: org_mark_2020-10-26T12-58-28+00-00_mini12.local_8B3133BA-A6E1-4CC7-B9B3-A4D300FB58CB
#+begin_src emacs-lisp
...
#+begin_src emacs-lisp
(setq elhome-settings-file-regexp (rx-to-string '(seq any "settings.el" eol)))
(defun mwb-init-customize-directory-files ()
  (directory-files mwb-init-customize-directory t
