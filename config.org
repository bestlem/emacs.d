...
(setq mwb-local-repos (expand-file-name "local-repos" mwb-emacs-work-dir))
...
*** Load use-package
:PROPERTIES:
:ID:       org_mark_mini20.local:20221231T180402.455625
:END:
#+NAME: org_mark_mini20.local_20221231T180402.404202
#+begin_src emacs-lisp
(straight-use-package 'use-package)
#+end_src
** Elpaca
:PROPERTIES:
:ID:       org_mark_mini20.local:20221231T180402.453117
:END:
*** Set paths
:PROPERTIES:
:ID:       org_mark_mini20.local:20221231T180402.450586
:END:
#+NAME: org_mark_mini20.local_20221231T180402.407128
#+begin_src emacs-lisp
...
*** Bootstrap
:PROPERTIES:
:ID:       org_mark_mini20.local:20221231T180402.447650
:END:
This uses a feature branch.
#+NAME: org_mark_mini20.local_20221231T180402.409206
#+begin_src emacs-lisp
...
*** use-package
:PROPERTIES:
:ID:       org_mark_mini20.local:20221231T180402.443446
:END:
#+NAME: org_mark_mini20.local_20221231T180402.412822
#+begin_src emacs-lisp
;; Install use-package
(elpaca use-package
...
*** Build queues
:PROPERTIES:
:ID:       org_mark_mini20.local:20221231T180735.618367
:END:
#+NAME: org_mark_mini20.local_20221231T180735.580311
#+begin_src emacs-lisp
;; Process use-package's queue. This will block!
(elpaca-wait)
#+end_src
** Helpers to set up how modes are set up
:PROPERTIES:
...
:END:
 ...
 Other packages are used elsewhere in init and so have to be force loaded
**** No littering
:PROPERTIES:
...
#+begin_src emacs-lisp
(message "looking at mac-key-mode")
(use-package-elpa mac-key-mode
  :unless *aquamacs*
  :elpaca (:host github :repo "bestlem/mac-key-mode"
...
*** Elpaca force load
:PROPERTIES:
:ID:       org_mark_mini20.local:20230101T114327.039474
:END:
#+NAME: org_mark_mini20.local_20230101T114327.011984
#+begin_src emacs-lisp
(elpaca-wait)
#+end_src
...
#+end_src
*** Local packages needed
:PROPERTIES:
:ID:       org_mark_mini20.local:20230101T123656.209609
:END:
** Customisation file
:PROPERTIES:
...
But as now elpaca makes me load this earlier this could be moved to after org
