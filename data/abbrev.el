...
(define-abbrev-table 'sql-mode-abbrev-table
  '(
    ("arc" "archivelog" nil :count 0)
    ("cl" "cluster" nil :count 0)
    ("co" "connect" nil :count 0)
    ("da" "date" nil :count 0)
    ("dec" "declare" nil :count 0)
    ("del" "delete" nil :count 0)
    ("dr" "drop" nil :count 0)
    ("f" "from" nil :count 0)
    ("fr" "from" nil :count 0)
    ("g" "group by" nil :count 0)
    ("gb" "group by" nil :count 0)
    ("gr" "grant" nil :count 0)
    ("gra" "grant all to" nil :count 0)
    ("ins" "insert" nil :count 0)
    ("nu" "number" nil :count 0)
    ("o" "order by" nil :count 0)
    ("ob" "order by" nil :count 0)
    ("pr" "priviledges" nil :count 0)
    ("pu" "public" nil :count 0)
    ("rb" "rollback" nil :count 0)
    ("ro" "rollback" nil :count 0)
    ("s" "select" nil :count 0)
    ("sy" "synonym" nil :count 0)
    ("ta" "table" nil :count 0)
    ("tr" "transaction" nil :count 0)
    ("u" "update" nil :count 0)
    ("un" "unique" nil :count 0)
    ("up" "update" nil :count 0)
    ("us" "using" nil :count 0)
    ("vc" "varchar" nil :count 0)
    ("w" "where" nil :count 0)
    ("whe" "whenever" nil :count 0)
   ))
