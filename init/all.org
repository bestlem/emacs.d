...
Elpaca runs on after-init-hook so change the hook
...
(add-hook 'elpaca-after-init-hook #'init-mwb-hook-after-init)
#+end_src
...
** Appearance
:PROPERTIES:
:ID:       org_mark_mini20.local:20230101T170038.101666
:END:
These have to be loaded earlier to deal with elpaca So needs a force wait for the queue,
#+NAME: org_mark_mini20.local_20230101T170038.081982
#+begin_src emacs-lisp
(mwb-init-load "init/appearance")
(mwb-init-load "init/treemacs")
