...
*** Hooks
:PROPERTIES:
:ID:       org_2020-12-08+00-00:A878C0A9-BBC9-40AB-8973-B13EC43511A0
:END:
But did not seem to be OK as focus out hook does not work
#+NAME: org_mark_2020-03-02T07-49-31+00-00_mini12.local_8B85D421-DEE1-4971-B1CB-CBD7C5678E5F
#+begin_src emacs-lisp
(add-hook 'after-save-hook       'garbage-collect 99) ; after all
;; (add-hook 'focus-out-hook        #'garbage-collect)
;; (add-hook 'minibuffer-exit-hook  #'garbage-collect)
(add-hook 'minibuffer-setup-hook #'garbage-collect)
(add-hook 'suspend-hook          #'garbage-collect 'run-at-end)
#+end_src
*** Idle
:PROPERTIES:
:ID:       org_2020-12-08+00-00:E95E52C2-A7E4-4F66-8381-DEAE792C715D
:END:
Having read help for `run-with-idle-timer` this seems better
#begin_quote
Perform an action the next time Emacs is idle for SECS seconds.
#end_quote
#+NAME: org_2020-12-08+00-00_C06726FA-D422-4216-92D1-CF3BA3B36A88
#+begin_src emacs-lisp :tangle no
...
** Backups
:PROPERTIES:
:ID:       org_2020-12-06+00-00:A4750F2D-10FD-495C-ABDC-E28A3E0B16B3
:END:
#+NAME: org_2020-12-06+00-00_EC0FE1B5-679F-4B79-9F7E-004BF38E5E4D
#+begin_src emacs-lisp
(setq delete-old-versions "keep them all")
...
So use separate PRIMARY and CLIPBOARD - hmm
...
**  tabs
:PROPERTIES:
:ID:       org_2020-12-05+00-00:2067C531-01D2-4988-98A8-1A6A7BE16371
:END:
#+NAME: org_2020-12-05+00-00_EA04789D-7F1B-4CB5-BBF4-4D476DB57D6E
#+begin_src emacs-lisp
