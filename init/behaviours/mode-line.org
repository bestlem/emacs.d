...
(doom-modeline-def-modeline 'main-headline
  '(bar major-mode  buffer-size minor-modes  buffer-position selection-info)
  '(  indent-info buffer-encoding  process checker))


(doom-modeline-def-modeline 'main
  '(bar workspace-name window-number modals  buffer-info remote-host  word-count parrot )
