...
Spacesand xonsh lack of reading startup files  put me back to a POSIX shell for running non interactive shells.- unfortunately Apple makes sh a link to bash - not dash. So I will use zsh
...
(let (;; (my-shell "/Users/mark/miniconda3/envs/xonsh/bin/xonsh")
  ...
  (setq explicit-shell-file-name "/Users/mark/miniconda3/envs/xonsh/bin/xonsh")
