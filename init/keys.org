...
(pretty-hydra-define hydra-mwb-main
  ...
  ("Hydrae" (("C" hydra-flycheck/body "Flycheck")
   ...
   "Current buffer" (("L" linum-mode "line number" :toggle t)
					 ...
					 ("Bf" refill-mode "Auto refill mode ")
					 ("BW" backup-walker-start "Backup Walker")
   ...
   (("de" toggle-debug-on-error "debug on error" :toggle (default-value 'debug-on-error))
    ...
    ("e" iedit-mode "iedit"))
   "Change Buffers" (("b" consult-buffer "Switch Buffer")
					 ("BM" counsel-bookmark "Jump to bookmark")
