...
(bind-key "A-b" 'consult-buffer macos-key-map)
...
:END:
TODO
As noted based on Sacha Chua's consult setup.

** Search
:PROPERTIES:
:ID:       org_mark_mini20.local:20210801T222808.557693
:END:
Again from Sasha Chua
#+NAME: org_mark_mini20.local_20210801T222808.532824
#+begin_src emacs-lisp
(pretty-hydra-define hydra-search
  ...
  ("Project"
   ...
   (("l" consult-line "Line")
	...
	("e" consult-isearch "Incremental search")
	("<f4>" consult-isearch "Incremental search")
	("o" occur "Occur")
	("." isearch-forward-symbol-at-point "isearch point")
...
(use-feature emacs
  :bind ( :map isearch-mode-map
			   ...
			   ("M-s l" . consult-line)
			   ("<f4>" . isearch-repeat-forward)
			   ("<f3>" . isearch-repeat-backward)))
#+end_src
