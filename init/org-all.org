...
:END:
- [[#start-using-org-mode][Start using org mode]]
...
- [[#load-and-setup-org-mode][Load and setup org mode]]
  ...
  - [[#prettify][Prettify]]
    ...
    - [[#set-fonts-for-headers][Set fonts for headers]]
    - [[#indent-other-text][Indent other text]]
    - [[#line-wrapping][Line wrapping]]
  - [[#agenda][Agenda]]
  - [[#capture][Capture]]
  - [[#mode-hydras][Mode Hydras]]
    - [[#main-mode][Main mode]]
    - [[#refile][Refile]]
      - [[#code][Code]]
      - [[#hydra][Hydra]]
...
org-babel-tangle-jump-to-org does mainly if :comments noweb is in the org :Properties: and the blockas have unique names
...
Now back to back to src issues. They go back to the code block that contains the noweb <<>> Not the named block
...
org_2020-11-27T22-41-01+00-00_451D7528-BB66-48C2-82FD-A2FC371DED3B
#+NAME: org_2020-11-27T22-41-01+00-00_055BDDEC-DC97-4652-AD82-8CC8EB9EF841
#+begin_src emacs-lisp
...
#+BEGIN_SRC emacs-lisp
(setq org-id-prefix (concat "org_" ;; (user-real-login-name) "_"
                            (help/get-timestamp-no-colons) ;; "_" (system-name)
                            ))
...
**** Hydra
:PROPERTIES:
:ID:       org_mark_2020-10-24T15-08-22+01-00_mini12.local:D4DA8CE4-DA9A-43D9-AE41-F2A5040BBDCB
:END:

I am not certain how to add a name in the use-package so use plain macro in :config
#+NAME: org_mark_2020-10-24T15-08-22+01-00_mini12.local_FD030CF2-2800-4F9B-A6DF-3E850A864309
#+begin_src emacs-lisp :tangle no
...
I think using treemacs is nearer what I need.
