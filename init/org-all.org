...
- [[#the-use-package-setup][The use package setup]]
  ...
  - [[#hide-property-drawers][Hide property drawers]]
    - [[#manual-attempt][Manual attempt]]
    - [[#melpa-code][MELPA code]]
  ...
  - [[#babel-initialisation][Babel initialisation]]
    ...
    - [[#my-changes][My changes]]
      ...
      - [[#jump-to-generated-code][Jump to generated code]]
  - [[#archive][Archive]]
...
ALso see https://github.com/amno1/org-hide-properties
*** Manual attempt
:PROPERTIES:
...
#+begin_src emacs-lisp
(use-package org-hide-properties
  :mwb-load-path "fork/org-hide-properties"
...
:PROPERTIES:
:ID:       org_mark_mini20.local:20220605T134305.891503
:END:
Use a standard formatter as whole file
