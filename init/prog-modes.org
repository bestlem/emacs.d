...
:END:
*** Autofill mode on comments and not code
:PROPERTIES:
...
:END:
Keeps chnaging - the issue is with comments before functions I want to collapse the lot. Plu with racket and ml comments are not in fits column so some (outshine) do not spot it.
...
*** emacs - ielm
:PROPERTIES:
:ID:       org_mark_2020-01-24T12-43-54+00-00_mini12:145FFE4A-96E9-4274-83C9-7713D5C26575
:END:
This is simple and works
#+NAME: org_mark_2020-01-24T12-43-54+00-00_mini12_50DBBC02-BB0B-43D7-8FD2-6ECB453AF222
#+BEGIN_SRC emacs-lisp
...
#+begin_src emacs-lisp
(defun mwb-eir-send-to-repl (function-name )
  "send the last sexpr to the replm using the given function"
  ;; (interactive "P")
