...
(use-package-elpa magit
  ...
  (jp-git
   ...
   ("Status" (("s" mwb-magit-status "status")
	...
	"Local" (("b" magit-branch "branch")
			 ("r" magit-rebase "rebase"))
	"Remote" (("f" magit-fetch "fetch")
			  ("P" magit-push "push")
			  ("F" magit-pull "pull"))
...
#+end_src
*** TODO Add a consult to move between hunks
:PROPERTIES:
:ID:       org_mark_mini20.local:20220612T114243.217186
:END:
See https://blog.binchen.org/posts/new-git-timemachine-ui-based-on-ivy-mode.html for an ivy version.
* Smerge
:PROPERTIES:
