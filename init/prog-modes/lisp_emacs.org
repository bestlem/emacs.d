  ...
  :mode-hydra ((:idle 0.5)
               ("Eval"
                ...
                (("a" hydra-lispy-mwb-alter/body "Alter...")
                 ...
                 ("f" srefactor-lisp-format-sexp "srefactor sexp"))
                "Debug"
                ...
                (("cc" emacs-lisp-byte-compile "Compile")
                 ("cl" emacs-lisp-byte-compile-and-load "Compile and Load")
                 ("cr" byte-recompile-directory "Byte Recompile Directory")
                 ("cx" disassemble "Disassemble")))))
#+end_src
...
(defun hemacs-imenu-elisp-expressions ()
  (dolist (pattern '( ("Features" "^(use-feature \\(.+\\)$" 1)
                      ("Sections" "^;;; \\(.+\\)$" 1)))
