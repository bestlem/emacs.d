...
Argh it is the normal problem that the keys I want are in minor mode ~mac-key~mode~ So none of these fixes work. So kill that mp - as had this issue before.
