...
* Minibuffer memory
  ...
  Note this causes a gc when minibuffer ends - perhaps not the best ti/me
  #+begin_src emacs-lisp
...
#+end_src
* Delete if selected
Also see [[https://www.emacswiki.org/emacs/DeleteSelectionMode][EmacsWiki]] but cua should do this
  #+begin_src emacs-lisp
