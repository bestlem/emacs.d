...
Major mode was missing the last line - I suspect due to echo area
...
*** Code
	...
	(use-package matcha
	  ...
	  (matcha-setup))
    #+end_src
*** Hydra space the root hydra
**** Note on unused or other changes
***** quickrun
	  runs the current buffer through a compiler or interpreter. There are also functions to do for a method. Includes C, Racket, Python, Julia
   #+begin_src emacs-lisp
   ...
   (defhydra hydra-space (:color blue :hint nil :idle .2)
	 ...
	 ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
	   ...
	   _i_ iBuffer    _p_ Project     _v_ Edit Init.el     _e_ Eval
	   _r_ Recent     _x_ kill buff   _o_ Org              _t_ Test
	   _n_ Treemacs   _U_ Undo        _u_ Universal Arg..  _=_ Format
	   _SPC_ Any
   "
	 ("1" digit-argument)
	 ("2" digit-argument)
	 ...
	 ("S" (lambda () (interactive) (save-some-buffers :all-buffers-no-confirm)))
   ...
   (bind-key "H-a" 'hydra-space/body)
   #+end_src
*** Hydra search
This is incomplete as many ofr the command will fail
 #+begin_src emacs-lisp
