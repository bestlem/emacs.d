;; $Header: /Volumes/General/link/mark/Library/Emacs/RCS/common-keys.el,v 1.1.1.7 2003/01/19 11:59:17 mark Exp $
...
(global-set-key [?\A-3]  '(lambda ()
							  (interactive)
							  (insert "#" )))
(global-set-key [?\s-3]  '(lambda ()
							  (interactive)
							  (insert "#" )))
...
((eq window-system 'mac)
 ...
 (global-set-key [C-help] 'cua-paste)
...
;; Revision 1.1.1.7  2003/01/19 11:59:17  mark
;; Merge in more apple
;;
