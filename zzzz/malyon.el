...
;; Credits: z8 support by Alberto Petrofsky <Alberto@petrofsky.berkeley.ca.us>
...
(defun malyon-print-header ()
  ...
  (malyon-newline)
  (malyon-print "(c) 1999, 2000 by Peter Ilberg <peter.ilberg@ni.com>")
  (malyon-newline)
  (malyon-print "Z8 support by Alberto Petrofsky ")
  (malyon-print "<Alberto@petrofsky.berkeley.ca.us>")
  (malyon-newline)
  (malyon-newline))
